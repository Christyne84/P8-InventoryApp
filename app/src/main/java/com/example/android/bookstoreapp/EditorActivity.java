...
public class EditorActivity extends AppCompatActivity {
    ...
    /*
     * Get user input from editor and save the new book into the database.
     */
    private void insertBook() {
        ...
        if (newRowId == -1) {
            ...
            Toast.makeText(this, getString(R.string.saved_confirmation) + newRowId, Toast.LENGTH_SHORT).show();
        }
    }
